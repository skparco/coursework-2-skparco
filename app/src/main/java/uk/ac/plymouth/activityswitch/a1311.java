...
public class a1311 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a1311);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        Button button_a13_done = (Button) findViewById(R.id.button_a1311_done);
        ...
        Button button_a131_cancel = (Button) findViewById(R.id.button_a1311_sure);
    ...
    protected void setAlertViewCancel() {
