...
public class a1411 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_a1411);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        Button button_a141_approve = (Button) findViewById(R.id.button_a1411_and_back);
    ...
    protected void setAlertViewApprove() {
        // set up intent
