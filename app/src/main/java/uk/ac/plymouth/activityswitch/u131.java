...
public class u131 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_u131);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);
        Button button_u131_cancel = (Button) findViewById(R.id.button_u131_cancel);
        button_u131_cancel.setOnClickListener(new View.OnClickListener() {
            @Override
